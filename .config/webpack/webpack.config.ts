  ...
  const baseConfig: Configuration = {
    ...
    module: {
      rules: [
        ...
        {
          test: /\.js$/,
          include: /node_modules[\\/]@axiomhq[\\/]mpl-codemirror/,
    ...
    resolve: {
      ...
      unsafeCache: true,
      alias: {
        '@codemirror/state': path.resolve(process.cwd(), 'node_modules/@codemirror/state'),
        '@codemirror/view': path.resolve(process.cwd(), 'node_modules/@codemirror/view'),
        '@codemirror/autocomplete': path.resolve(process.cwd(), 'node_modules/@codemirror/autocomplete'),
        '@codemirror/lint': path.resolve(process.cwd(), 'node_modules/@codemirror/lint'),
      },
    },
  };
